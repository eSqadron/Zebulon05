...
public:
    ThreeLegsController() : Node("three_legs_controller"){
        ...
        rclcpp::sleep_for(std::chrono::nanoseconds(20000000000));
...
private:
    void timer_callback()
    {
        ...
        RCLCPP_INFO(this->get_logger(), (static_cast<std::string>("step_status: ") + std::to_string(is_step_stage_done_)).c_str());
