...
//        int leg_3_pos = get_pos_from_leg("leg_3");
        ...
        leg_no_step_done_ = std::array<float, 3>{true, true, true};

        xy_leg_positions_ = std::array<float, 3>{std::array<float, 3>{150, 0, -100}, std::array<float, 3>{150, 0, -100}, std::array<float, 3>{150, 0, -100}};
