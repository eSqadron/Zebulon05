...
static const _Step_type_support_symbol_names_t _Step_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, walking_robot_interfaces, msg, Step)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, walking_robot_interfaces, msg, Step)),
  }
};
...
{
  return &::walking_robot_interfaces::msg::rosidl_typesupport_cpp::Step_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, walking_robot_interfaces, msg, Step)() {
  return get_message_type_support_handle<walking_robot_interfaces::msg::Step>();
}
